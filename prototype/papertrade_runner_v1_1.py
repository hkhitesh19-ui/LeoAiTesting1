...
def main():
    log_event("BOOT", {"msg": "papertrade runner v1.1 starting", "ts": _utcnow()})
    ...
    log_event("PAPERTRADE_STEP", {"decision": sig.get("decision"), "close": sig.get("close"), "action": result.get("action")})
